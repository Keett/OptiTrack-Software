...
int main(int argc, char* argv[])
{
    ...
    while(1)
    {
        ...
        if(frame)
        {
            ...
            //== Image processing is implemented in the fragment shader ===--

            float blurIntensity = sin(frame->FrameID()*0.01f)*5;
            ...
            if(!DrawGLScene(&Texture, frame->Width(), frame->Height(),blurIntensity))  
                break;
